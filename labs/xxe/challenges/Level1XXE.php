  ...
  <div class="terminal-container">
    ...
    <div class="mission-briefing">
      ...
      <div class="briefing-content">
        ...
        <p>Exploit the XML parser to read sensitive files from the server. The system accepts XML agent reports but
          doesn't properly disable external entities.</p>
        <p class="hint-text">Craft a malicious XML payload with an external entity that reads <code>/etc/passwd</code>
          or other sensitive files.</p>
      </div>
    </div>
    ...
    <div class="terminal-form">
      ...
      <form method="POST" class="mil-form">
        <div class="form-group">
          ...
          <textarea id="xml_data" name="xml_data" rows="10" class="mil-input mil-textarea"
            placeholder="Enter XML content..."><?php echo htmlspecialchars($this->xmlContent ?: '<?xml version="1.0"?>
<agent_report>
...
&lt;/agent_report&gt;</code></pre>
    ...
    <details class="intel-briefing">
      ...
      <div class="briefing-details">
        <p>XXE (XML External Entity) attacks occur when XML parsers allow external entity references. By defining a
          custom entity that references a file, you can read server files.</p>
        <p>The DOCTYPE declaration allows you to define entities. Use
          <code>&lt;!ENTITY name SYSTEM "file:///path/to/file"&gt;</code> to reference files.
        </p>
