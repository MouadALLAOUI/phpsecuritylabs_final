  ...
  <div class="terminal-body">
    <form method="POST" id="xssForm">
      <div style="margin-bottom: 20px;">
        ...
        <input type="text" name="search" class="mil-input" 
               placeholder="Search by codename or real name..." 
               value="<?= htmlspecialchars($this->searchQuery) ?>" 
               autocomplete="off">
      </div>
...
<span class="text-dim">[10:23:45]</span> <span class="text-blue">AGENT_VIPER:</span> Has anyone checked the new database terminal?
<span class="text-dim">[10:24:12]</span> <span class="text-blue">AGENT_ECHO:</span> Yeah, seems slow but functional
<span class="text-dim">[10:25:03]</span> <span class="text-blue">ADMIN:</span> Reviewing search logs now. Stand by.
<span class="text-dim">[10:25:45]</span> <span class="text-amber">SYSTEM:</span> Admin access granted to search history
    </div>
  </div>
</div>
